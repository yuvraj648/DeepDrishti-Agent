...
// Mock data for testing marine surveillance API
const mockFeeds = [
  {
    _id: '1',
    ...
    status: 'active',
    location: 'Pacific North — Live/relay',
    sector: 'Sector Alpha',
  ...
  },
  {
    ...
    status: 'active',
    location: 'Pacific South — Live/relay',
    sector: 'Sector Delta',
...
// Test endpoints for marine surveillance (no auth required)

// GET /api/v1/test/feeds - Get all feeds
...
// GET /api/v1/test/feeds/active - Get active feeds only
router.get('/feeds/active', (req, res) => {
...
// GET /api/v1/test/feeds/:id - Get single feed by ID
...
// GET /api/v1/test/alerts - Get all alerts
...
// GET /api/v1/test/alerts/active - Get active alerts only
...
// GET /api/v1/test/alerts/:id - Get single alert by ID
...
// GET /api/v1/test/dashboard/summary - Get dashboard summary
...
// GET /api/v1/test/dashboard/system-status - Get system status
router.get('/dashboard/system-status', (req, res) => {
  res.json({
    success: true,
    data: {
      timestamp: new Date(),
...
// GET /api/v1/test/dashboard/surveillance/:feedId - Get surveillance mode data
router.get('/dashboard/surveillance/:feedId', (req, res) => {
